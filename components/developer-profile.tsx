      ...
      <Card>
        ...
        <CardContent>
          <p className="text-sm text-gray-500 mb-4">
            Please select your proficiency level for languages you have experience with. You can leave others blank.
          </p>
          ...
          <Tabs defaultValue="systems" className="w-full">
            ...
            {languageGroups.map((group) => (
              <TabsContent key={group.name.toLowerCase()} value={group.name.toLowerCase()} className="space-y-4 mt-4">
                  ...
                  {group.languages.map((language) => (
                    <div key={language} className="space-y-2">
                      ...
                      >
                        ...
                        <SelectContent>
                          <SelectItem value="not_applicable">Not Applicable / No Experience</SelectItem>
